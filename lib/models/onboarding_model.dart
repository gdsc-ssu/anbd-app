  ...
  static final List<OnboardingInfo> items = [
    ...
    OnboardingInfo(
        contentSpans: [
          ...
          const TextSpan(text: "무료나눔", style: TextStyle(color: Color(0xFF1E88E5))),
          const TextSpan(text: "하고", style: TextStyle(color: Colors.black)),
        ],
    ...
    OnboardingInfo(
        contentSpans: [
          ...
          const TextSpan(text: "기부", style: TextStyle(color: Color(0xFF1E88E5))),
          const TextSpan(text: "할 수 있어요", style: TextStyle(color: Colors.black)),
        ],
