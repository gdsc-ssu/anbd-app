...
class OnboardingItems {
  ...
  List<OnboardingInfo> items = [
    ...
    OnboardingInfo(
        content: "버리는 대신, ANBD에 업로드해서 새 주인을 찾아줄 수 있어요",
        image: "$basePath/onboarding2.png"),

    OnboardingInfo(
        content: "ANBD에서는 내가 가지고 있는 물건을 이웃에게 무료나눔 하고",
        image: "$basePath/onboarding3.png"),

    OnboardingInfo(
        content: "나눔한 금액을 내 이름으로 환경을 위해 기부할 수 있어요",
        image: "$basePath/onboarding4.png"),

    OnboardingInfo(
        content: "ANBD를 통해 이웃과 정을 나누고 환경을 지켜요",
